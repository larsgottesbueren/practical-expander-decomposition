...
namespace SubsetGraph {
    ...
    public:
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::const_iterator cbegin() const { return vertices.cbegin(); }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::iterator end() { return vertices.begin() + vertexBound.top().middle; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::const_iterator cend() const { return vertices.cbegin() + vertexBound.top().middle; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::iterator beginRemoved() { return vertices.begin() + vertexBound.top().middle; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::const_iterator cbeginRemoved() const { return vertices.cbegin() + vertexBound.top().middle; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::iterator endRemoved() { return vertices.begin() + vertexBound.top().end; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<V>::const_iterator cendRemoved() const { return vertices.cbegin() + vertexBound.top().end; }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<E>::const_iterator cbeginEdge(V u) const { return edges[u].cbegin(); }
        ...
        /**
           ...
           Time complexity: O(1)
         */
        typename std::vector<E>::iterator endEdge(V u) { return edges[u].begin() + edgeBounds[u].top().middle; }
         ...
         */
        template<typename It>
        int volume(It subsetBegin, It subsetEnd) const {
            int total = 0;
            for (auto it = subsetBegin; it != subsetEnd; ++it)
                total += degree(*it);
            return total;
         ...
         */
        template<typename It>
        int globalVolume(It subsetBegin, It subsetEnd) const {
            int total = 0;
            for (auto it = subsetBegin; it != subsetEnd; ++it)
                total += globalDegree(*it);
            return total;
         ...
         */
        template<typename It>
        void subgraph(It subsetBegin, It subsetEnd) {
            vertexBound.push({ 0, int(std::distance(subsetBegin, subsetEnd)) });

            for (auto it = subsetBegin; it != subsetEnd; ++it) {
                const int fromIdx = vertexIndices[*it], toIdx = vertexBound.top().middle++;
                std::swap(vertices[fromIdx], vertices[toIdx]);
                vertexIndices[vertices[fromIdx]] = fromIdx;
                vertexIndices[vertices[toIdx]] = toIdx;
            }

            assert(vertexBound.top().middle == vertexBound.top().end && "Incorrect number of vertices added.");
